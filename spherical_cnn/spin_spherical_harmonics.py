...
class SpinSphericalFourierTransformer(nn.Module):
  ...
  def validate(self, resolution: int, spin: int) -> bool:
  ...
  def swsft_forward(self, sphere: Array, spin: int) -> jnp.ndarray:
  ...
  def swsft_forward_with_symmetry(
      self, sphere: Array, spin: int) -> jnp.ndarray:
    ...
    deltas = deltas * deltas[..., ell_max - spin][..., None]
  ...
  def _compute_Gnm_spins_channels(
    ...
    deltas_s = jnp.stack([deltas[..., ell_max - spin]
  ...
  def swsft_backward(self, coeffs: Array, spin: int) -> jnp.ndarray:
  ...
  def swsft_backward_with_symmetry(
      self, coeffs: Array, spin: int) -> jnp.ndarray:
  ...
  def swsft_forward_spins_channels(
      ...
      sphere_set: Array,
      spins: Collection[int],
      ell_max: Optional[int] = None) -> jnp.ndarray:
  ...
  def swsft_backward_spins_channels(self,
                                    coeffs_set: Array,
                                    spins: Collection[int]) -> jnp.ndarray:
...
def coefficients_to_matrix(coeffs: Array) -> jnp.ndarray:
