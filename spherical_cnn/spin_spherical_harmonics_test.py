    ...
    for channel in range(n_channels):
      for spin in spins:
        ...
        sliced = transformer.apply(
            variables, sphere_set[..., spin, channel], spin,
            method=TransformerModule.swsft_forward)
        self.assertAllClose(coefficients[..., spin, channel], sliced)
  ...
  def test_swsft_backward_spins_channels_matches_swsft_backward(self):
    ...
    for channel in range(n_channels):
      for spin in spins:
        ...
        sliced = transformer.apply(
            variables, coefficients[..., spin, channel], spin,
            method=TransformerModule.swsft_backward)

        self.assertAllClose(sphere[..., spin, channel], sliced)
